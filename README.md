...
- Current visible version: `v117.0`
...
- SEO/AIO prep: production-style titles, descriptions, canonical URLs, Open Graph/Twitter tags, schema.org JSON-LD, pre-rendered route body content, visible FAQ blocks, `robots.txt`, refreshed `sitemap.xml`, and `llms.txt`
