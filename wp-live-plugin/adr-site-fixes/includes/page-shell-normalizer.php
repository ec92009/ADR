...
<div class="adr-refresh-stage adr-home-clean-mock">
  <style>
    ...
    html.adr-pdf-export .adr-mini-nav { position: static !important; top: auto !important; z-index: auto !important; }
    @media print { .adr-mini-nav { position: static !important; top: auto !important; z-index: auto !important; } }
...
<div class="adr-page-stage adr-quote-stage">
  <style>
    ...
    .adr-side-card h2, .adr-form-card h2, .adr-step-card h2 { margin: 0; max-width: 100%; min-width: 0; color: var(--adr-blue); line-height: 1.12; letter-spacing: 0; overflow-wrap: anywhere; word-break: normal; hyphens: auto; }
...
<div class="adr-page-stage adr-cabinet-stage">
  <style>
    ...
    .adr-info-card h2, .adr-cta-strip h2 { margin: 0; max-width: 100%; min-width: 0; color: var(--adr-blue); font-size: clamp(22px, 2.35vw, 34px); line-height: 1.12; letter-spacing: 0; overflow-wrap: anywhere; word-break: normal; hyphens: auto; }
    ...
    .adr-detail-header h2, .adr-detail-card h2 { margin: 0; max-width: 100%; min-width: 0; color: var(--adr-blue); line-height: 1.12; letter-spacing: 0; overflow-wrap: anywhere; word-break: normal; hyphens: auto; }
...
<div class="adr-page-stage adr-legal-stage adr-privacy-stage">
  ...
  <section class="adr-info-grid" aria-label="Repères">
    <article class="adr-info-card"><img decoding="async" src="https://ec92009.github.io/ADR/mock-assets/adr-icon-house-gold.svg" alt=""><h2>Données collectées</h2><p>Coordonnées, informations de dossier, adresse IP et localisation approximative utiles au traitement et à la sécurité.</p></article><article class="adr-info-card"><img decoding="async" src="https://ec92009.github.io/ADR/mock-assets/adr-icon-house-gold.svg" alt=""><h2>Consentement</h2><p>Transmission aux partenaires uniquement dans le cadre accepté par le client.</p></article><article class="adr-info-card"><img decoding="async" src="https://ec92009.github.io/ADR/mock-assets/adr-icon-house-gold.svg" alt=""><h2>Droits</h2><p>Accès, modification, suppression et opposition par courrier au siège.</p></article>
  </section>
...
function adr_render_version_footer() {
    ...
    <div class="adr-version-footer" aria-label="Version du site">v134.0</div>
