...
final class ADR_Site_Fixes_Live_Visual_Refresh {
    private const MARKER = 'adr-live-visual-refresh-v120-2';
    private const CONTACT_FORM_ID = 7487;
    private const ASSET_BASE = 'https://ec92009.github.io/ADR/assets/';
    private const THEME_SCRIPT = 'https://ec92009.github.io/ADR/adr-theme-persistence.js?v=120.2';
    ...
    private static function replace_versions( $html ) {
        $replacements = array(
            ...
            'adr-fr-only-v120-1'                 => 'adr-fr-only-v120-2',
            'adr-fr-only-v120-0'                 => 'adr-fr-only-v120-2',
            'adr-fr-only-v119-7'                 => 'adr-fr-only-v120-2',
            'adr-fr-only-v119-6'                 => 'adr-fr-only-v120-2',
            'adr-fr-only-v119-5'                 => 'adr-fr-only-v120-2',
            'adr-fr-only-v119-3'                 => 'adr-fr-only-v120-2',
            'adr-source-truth-residuals-v120-1'  => 'adr-source-truth-residuals-v120-2',
            'adr-source-truth-residuals-v120-0'  => 'adr-source-truth-residuals-v120-2',
            'adr-source-truth-residuals-v119-7'  => 'adr-source-truth-residuals-v120-2',
            'adr-source-truth-residuals-v119-6'  => 'adr-source-truth-residuals-v120-2',
            'adr-source-truth-residuals-v119-5'  => 'adr-source-truth-residuals-v120-2',
            'adr-source-truth-residuals-v119-3'  => 'adr-source-truth-residuals-v120-2',
            'adr-live-quote-form-v120-1'         => 'adr-live-quote-form-v120-2',
            'adr-live-quote-form-v120-0'         => 'adr-live-quote-form-v120-2',
            'adr-live-quote-form-v119-7'         => 'adr-live-quote-form-v120-2',
            'adr-live-quote-form-v119-6'         => 'adr-live-quote-form-v120-2',
            'adr-live-quote-form-v119-5'         => 'adr-live-quote-form-v120-2',
            'adr-live-quote-form-v119-3'         => 'adr-live-quote-form-v120-2',
            'adr-live-visual-refresh-v120-1'     => 'adr-live-visual-refresh-v120-2',
            'adr-live-visual-refresh-v120-0'     => 'adr-live-visual-refresh-v120-2',
            'adr-live-visual-refresh-v119-7'     => 'adr-live-visual-refresh-v120-2',
            'adr-live-visual-refresh-v119-6'     => 'adr-live-visual-refresh-v120-2',
            'adr-live-visual-refresh-v119-5'     => 'adr-live-visual-refresh-v120-2',
            'adr-live-visual-refresh-v119-3'     => 'adr-live-visual-refresh-v120-2',
            'adr-theme-persistence-v120-1'       => 'adr-theme-persistence-v120-2',
            'adr-theme-persistence-v120-0'       => 'adr-theme-persistence-v120-2',
            'adr-theme-persistence-v119-7'       => 'adr-theme-persistence-v120-2',
            'adr-form-phone-preserver-v120-1'    => 'adr-form-phone-preserver-v120-2',
            'adr-form-phone-preserver-v120-0'    => 'adr-form-phone-preserver-v120-2',
            'adr-form-phone-preserver-v119-7'    => 'adr-form-phone-preserver-v120-2',
            "version = '120.1'"                  => "version = '120.2'",
            "version = '120.0'"                  => "version = '120.2'",
            "version = '119.7'"                  => "version = '120.2'",
            "version = '119.6'"                  => "version = '120.2'",
            "version = '119.5'"                  => "version = '120.2'",
            "version = '119.3'"                  => "version = '120.2'",
            'v120.1'                             => 'v120.2',
            'v120.0'                             => 'v120.2',
            'v119.7'                             => 'v120.2',
            'v119.6'                             => 'v120.2',
...
CSS;
    ...
    private static function ensure_theme_persistence( $html ) {
        $script = '<script id="adr-theme-persistence-v120-2" src="' . esc_url( self::THEME_SCRIPT ) . '"></script>';

        $html = preg_replace(
            '#<script id="adr-theme-persistence-v(?:119|120)-[^"]*" src="[^"]*"></script>#',
            $script,
            $html
        );

        if ( strpos( $html, 'id="adr-theme-toggle"' ) === false || strpos( $html, 'adr-theme-persistence-v120-2' ) !== false ) {
            return $html;
        }
    ...
    private static function ensure_phone_preserver( $html ) {
        if ( strpos( $html, 'name="telephone"' ) === false || strpos( $html, 'adr-form-phone-preserver-v120-2' ) !== false ) {
            return $html;
        }
    ...
    private static function phone_preserver_script() {
        return <<<'HTML'
<script id="adr-form-phone-preserver-v120-2">
(function () {
