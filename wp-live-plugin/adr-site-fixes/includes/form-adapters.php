...
// adr-live-quote-form-v135-1: refreshed quote form shell, preserving MetForm storage.
...
function adr_render_live_quote_form() {
    ...
    ?>
    <style id="adr-live-quote-form-v135-1">
    ...
    <script id="adr-live-quote-form-v135-1">
    (function () {
        var version = '135.1';
