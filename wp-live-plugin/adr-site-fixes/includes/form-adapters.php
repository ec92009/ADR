...
// adr-live-quote-form-v125-2: refreshed quote form shell, preserving MetForm storage.
...
function adr_render_live_quote_form() {
    ...
    ?>
    <style id="adr-live-quote-form-v125-2">
    ...
    <script id="adr-live-quote-form-v125-2">
    (function () {
        var version = '125.2';
