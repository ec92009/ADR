...
// adr-live-quote-form-v134-0: refreshed quote form shell, preserving MetForm storage.
...
function adr_render_live_quote_form() {
    ...
    ?>
    <style id="adr-live-quote-form-v134-0">
    ...
    <script id="adr-live-quote-form-v134-0">
    (function () {
        var version = '134.0';
