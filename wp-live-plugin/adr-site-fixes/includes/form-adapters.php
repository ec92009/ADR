...
// adr-live-quote-form-v135-0: refreshed quote form shell, preserving MetForm storage.
...
function adr_render_live_quote_form() {
    ...
    ?>
    <style id="adr-live-quote-form-v135-0">
    ...
    <script id="adr-live-quote-form-v135-0">
    (function () {
        var version = '135.0';
